...
import (
	...
	_ "nexus/x/nexus/module"
	nexusmoduletypes "nexus/x/nexus/types"
	"time"
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					BeginBlockers: []string{
						...
						// chain modules
						nexusmoduletypes.ModuleName, evmmoduletypes.ModuleName},
					EndBlockers: []string{
						govtypes.ModuleName,
						stakingtypes.ModuleName,
						feegrant.ModuleName,
			...
			{
				Name:   nexusmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&nexusmoduletypes.Module{}),
			}, {
