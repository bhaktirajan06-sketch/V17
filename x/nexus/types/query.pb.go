...
// source: nexus/nexus/v1/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9ab75c01c24b8862, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9ab75c01c24b8862, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "nexus.nexus.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "nexus.nexus.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("nexus/nexus/v1/query.proto", fileDescriptor_9ab75c01c24b8862) }

var fileDescriptor_9ab75c01c24b8862 = []byte{
	// 295 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xca, 0x4b, 0xad, 0x28,
	0x2d, 0xd6, 0x87, 0x90, 0x65, 0x86, 0xfa, 0x85, 0xa5, 0xa9, 0x45, 0x95, 0x7a, 0x05, 0x45, 0xf9,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x21, 0x63, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xc3,
	0x63, 0x08, 0x07, 0xd7, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nexus.nexus.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nexus.nexus.v1.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nexus.nexus.v1.Query",
	...
	Metadata: "nexus/nexus/v1/query.proto",
}
